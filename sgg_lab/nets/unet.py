...
def unet(input_shape=(256, 256, 1)):
    ...
    up6 = Conv2D(
        512, 2, activation='relu', padding='same',
        kernel_initializer='he_normal'
    ...
    up7 = Conv2D(
        256, 2, activation='relu', padding='same',
        kernel_initializer='he_normal'
    ...
    up8 = Conv2D(
        128, 2, activation='relu', padding='same',
        kernel_initializer='he_normal'
    ...
    up9 = Conv2D(
        64, 2, activation='relu', padding='same',
        kernel_initializer='he_normal'
    ...
    conv9 = Conv2D(
        2, 3, activation='relu', padding='same',
        kernel_initializer='he_normal'
    )(conv9)
