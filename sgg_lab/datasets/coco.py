...
class CocoDataset(utils.Dataset):
    ...
    def load_coco(self, dataset_dir, subset, year="2017",
        ...
        year: What dataset year to load (2014, 2017) as a string,
              not an integer
    ...
    def annToRLE(self, ann, height, width):
        ...
        which can be polygons, uncompressed RLE to RLE.
    ...
    def annToMask(self, ann, height, width):
        ...
        which can be polygons, uncompressed RLE, or RLE to binary mask.
        :return: binary mask (numpy 2D array)
        """
...
def build_coco_results(dataset, image_ids, rois, class_ids, scores, masks):
    """Arrange resutls to match COCO specs

    See http://cocodataset.org/#format
    """
    ...
    for image_id in image_ids:
        ...
        for i in range(rois.shape[0]):
            ...
            result = {
                ...
                "bbox": [bbox[1], bbox[0], bbox[3] - bbox[1],
                         bbox[2] - bbox[0]],
                "score": score,
